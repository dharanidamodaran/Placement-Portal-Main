      ...
      <section id="candidates" class="content-header">
        <div class="container">
          <div class="row">
            ...
            <h3 class="text-center margin-bottom-20">Add companies for placement</h3>
            <form method="post" id="registerCandidates" action="adding-companies.php" enctype="multipart/form-data">
              <div class="col-md-6 latest-job ">
                <div class="form-group">
                  <input class="form-control input-lg" type="text" id="companyname" name="companyname" placeholder="Company Name *" required>
                </div>
                
                <div class="form-group">
                  <textarea class="form-control input-lg" rows="6" id="skills" name="skills" placeholder="Skills required *" required></textarea>
                </div>
                <div class="form-group">
                  <!-- <input class="form-control input-lg" type="text" id="qualification" name="qualification" placeholder="Highest Qualification *"> -->
                  <select name="qualification" id="qualification" class="form-control input-lg">
                    <option value="nil">---Select educational qualification---</option>
                    <option value="MCA">MCA</option>
                    <option value="BCA">MCA</option>
                    <option value="BSc SS">BSc SS</option>
                    <option value="MSc SS">MSc SS</option>
                  </select>
                </div>
                <div class="form-group">
                  <input class="form-control input-lg" type="text" id="cgpa" name="cgpa" placeholder="Minimum CGPA *">
                </div>
                <div class="form-group">
                  <input class="form-control input-lg" type="text" id="website" name="website" placeholder="Company website *">
                </div>
                <div class="form-group">
                  <label>Upload/Change Company Icon</label>
              ...
              <div class="col-md-6 latest-job ">
                ...
                <div class="form-group">
                  <input class="form-control input-lg" type="text" id="branch" name="branch" minlength="10" maxlength="10"  placeholder="Branch *">
                </div>
                <div class="form-group">
                  <textarea class="form-control input-lg" rows="6" id="description" name="description" placeholder="Brief description *"></textarea>
                </div>
                <div class="form-group">
                  <input class="form-control input-lg" type="text" id="minsalary" name="minsalary" placeholder="minimum salary *">
                </div>
                <div class="form-group">
                  <input class="form-control input-lg" type="text" id="maxsalary" name="maxsalary" placeholder="maximum salary *">
                </div>
                <div class="form-group">
