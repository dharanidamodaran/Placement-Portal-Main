              ...
              <div class="box box-solid">
                <div class="box-header with-border">
                  <h3 class="box-title">Welcome <b><?php echo $_SESSION['name']; ?></b></h3>
				    ...
				    <?php if(isset($_SESSION['id_profilepic'])) { ?>
				  <img src="../uploads/logo/<?php echo $_SESSION['id_profilepic']; ?>" style="height:200px; width:200px; />
				  <?php } ?>
              ...
              <div class="row margin-top-20">
                <div class="col-md-12">
                  ...
                  ?>
                      ...
                      <div class="pull-right">
                        <a style="margin-left:2px; display:none;" href="updatedrive.php?id=<?php echo $row['id_jobpost']; ?>" class="btn btn-default btn-lg btn-flat margin-top-20"><i class="fa fa-arrow-circle-lef" "></i> Update Drive</a>
                      </div>
                  <?php
                    }
                  }
